    ...
    <section className="py-24 px-6 md:px-12 2xl:py-32 2xl:px-16 bg-white">
      <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto">
        ...
        <div className="max-w-4xl 2xl:max-w-5xl mb-10 2xl:mb-14">
          <h2 className="text-4xl md:text-6xl 2xl:text-7xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-12 2xl:mb-16">
            Pioneering Digital Excellence <br />
            <span className="text-gray-400 font-light italic">
              in the heart of Rwanda.
            </span>
          </h2>
          <p className="text-xl md:text-2xl 2xl:text-3xl text-gray-500 font-light leading-relaxed max-w-3xl 2xl:max-w-4xl">
        ...
        <div className="pt-10 2xl:pt-14 border-t border-gray-100">
          <div className="grid md:grid-cols-3 gap-12 lg:gap-24 2xl:gap-32">
            {[
              ...
              <div key={item.title} className="space-y-4 2xl:space-y-6">
                <h4 className="text-lg 2xl:text-xl font-bold text-gray-900 tracking-tight underline decoration-gray-100 underline-offset-8">
                  {item.title}
                </h4>
                <p className="text-gray-500 font-light leading-relaxed text-sm md:text-base 2xl:text-lg">
                  {item.desc}
                </p>
              </div>
            ))}
