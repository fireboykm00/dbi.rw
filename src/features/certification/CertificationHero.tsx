...
const CertificationHero = () => {
  return (
    <div className="p-2">
      <section className="relative min-h-[70vh] md:min-h-[70vh] lg:min-h-[70vh] w-full overflow-hidden rounded-xl flex flex-col justify-end bg-black">
        {/* Background Image */}
        ...
        {/* Content */}
        <div className="relative z-10 px-6 md:px-12 2xl:px-16 max-w-7xl 2xl:max-w-[1600px] mx-auto w-full flex flex-col items-start justify-end pt-40 pb-12 2xl:pb-20">
