    ...
    <div className="w-full bg-white">
      ...
      <div className="p-2">
        <section className="relative w-full overflow-hidden rounded-[20px]">
          ...
          {/* Content Container */}
          <div className="relative z-10 flex flex-col justify-end min-h-[50vh] md:min-h-[600px] lg:min-h-[500px] xl:min-h-[600px] max-w-7xl mx-auto px-4 md:px-6 lg:px-12 pt-16 md:pt-24 pb-8 md:pb-12">
      ...
      <section className="py-12 px-4 md:py-24 md:px-6 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-12 lg:gap-8 xl:gap-12 items-center">
